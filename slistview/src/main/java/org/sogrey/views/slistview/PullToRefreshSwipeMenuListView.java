...
import org.sogrey.views.slistview.SwipeMenuListView.SwipeMenu;
import org.sogrey.views.slistview.SwipeMenuListView.SwipeMenuCreator;
import org.sogrey.views.slistview.SwipeMenuListView.SwipeMenuLayout;
import org.sogrey.views.slistview.SwipeMenuListView.SwipeMenuView;
import org.sogrey.views.slistview.pulltorefresh.PullToRefreshListFooter;
import org.sogrey.views.slistview.pulltorefresh.PullToRefreshListHeader;
...
public class PullToRefreshSwipeMenuListView extends ListView implements OnScrollListener {
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        super.setAdapter(new PullToRefreshSwipeMenuAdapter(getContext(),adapter) {
            @Override
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                mLastY=-1; // reset
                if (mEnablePullLoad&&mFooterView.getHeight()>0&&mFooterView.getBottomMargin()
