package org.sogrey.views.slistview.pulltorefresh;
...
import org.sogrey.views.slistview.R;
...
public class PullToRefreshListFooter extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        addView(moreView);
        moreView.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT,LayoutParams
                .WRAP_CONTENT));
