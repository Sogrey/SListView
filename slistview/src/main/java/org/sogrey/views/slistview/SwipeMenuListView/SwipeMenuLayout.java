...
public class SwipeMenuLayout extends FrameLayout {
    ...
    public SwipeMenuLayout(
            View contentView,SwipeMenuView menuView,Interpolator closeInterpolator,
    ...
    private void init() {
        setLayoutParams(new AbsListView.LayoutParams(LayoutParams.MATCH_PARENT,LayoutParams
                .WRAP_CONTENT));
        ...
        mMenuView.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT,LayoutParams
                .WRAP_CONTENT));
